...
public class RulesServiceCache {
	...
	private void getRulesForAllServicesFromDb() {
		...
		serviceIdToAlgorithmMap.put("Service2" , RateLimitterAlgorithm.SlidingWindowCounterAlgorithm);
		Rule ruleForService2 = new SlidingWindowCounterRule(1000, 2); // use a factory to create the specific algorithm
		serviceIdToRuleCache.put("Service2", ruleForService2);
	}
